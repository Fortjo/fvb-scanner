...
# [WIDER SCAN] full current S&P 500 constituents, pulled from the maintained
# GitHub dataset (github.com/datasets/s-and-p-500-companies), '.' replaced
# with '-' for yfinance compatibility (e.g. BRK.B -> BRK-B).
UNIVERSE = SP500_TICKERS  # was: MOMENTUM_TICKERS + BLUECHIP_TICKERS (~82 names)
# To go back to the smaller, faster curated list:
# UNIVERSE = MOMENTUM_TICKERS + BLUECHIP_TICKERS
